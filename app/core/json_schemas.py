"""JSON Schema constants for OpenAI structured outputs."""

# JSON Schema for pedagogical report generation
REPORT_JSON_SCHEMA = {
    "type": "json_schema",
    "json_schema": {
...
# JSON Schema for pedagogical suggestions generation
...
# JSON Schema for input validation (educational relevance)
